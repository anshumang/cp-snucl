...
//   printf("dim : %d, %d, %d %d, abc : %f, %f, %f, ijk0 : %d, %d, %d, ijk1 : %d, %d, %d\npixel : %d, %d, %d, %d, %d, %d, %d, %d\n", dim[0], dim[1], dim[2], dim[3],  abc[0], abc[1], abc[2], ijk0[0], ijk0[1], ijk0[2], ijk1[0], ijk1[1], ijk1[2], pixel[0], pixel[1], pixel[2], pixel[3], pixel[4], pixel[5], pixel[6], pixel[7]);
