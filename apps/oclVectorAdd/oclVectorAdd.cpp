...
int main(int argc, char **argv)
{
    ...
    szGlobalWorkSize = 2 * szGlobalWorkSize;
    shrLog("Global Work Size \t\t= %u\nLocal Work Size \t\t= %u\n# of Work Groups \t\t= %u\n\n", 
           szGlobalWorkSize, szLocalWorkSize, (szGlobalWorkSize % szLocalWorkSize + szGlobalWorkSize/szLocalWorkSize)); 

    // Allocate and initialize host arrays 
    shrLog( "Allocate and Init Host Mem...\n"); 
    shrLog("%d %d\n", sizeof(cl_float), sizeof(int));
    ...
    Golden = (void *)malloc(sizeof(cl_float) * 2*iNumElements);
    shrFillArray((float*)srcA, 2*iNumElements);
    shrFillArray((float*)srcB, 2*iNumElements);
    ...
    int iNumElements2 = 2*iNumElements;
    ...
    ciErr1 |= clSetKernelArg(ckKernel, 3, sizeof(cl_int), (void*)&iNumElements2);
    ...
    VectorAddHost ((const float*)srcA, (const float*)srcB, (float*)Golden, 2*iNumElements);
    shrBOOL bMatch = shrComparefet((const float*)Golden, (const float*)dst, 2*(unsigned int)iNumElements, 0.0f, 0);
